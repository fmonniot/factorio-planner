...
| Flatten subplans            | Active   | [flatten-subplans/](flatten-subplans/)                 |
...
Outstanding sequenced work lives in [roadmap.md](roadmap.md) (Phases 6 and 7)
until it gets promoted into its own folder.
